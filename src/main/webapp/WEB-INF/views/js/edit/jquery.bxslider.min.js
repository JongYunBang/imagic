...
!function (t) {
    ...
    t.fn.bxSlider = function (n) {
        ...
        return r.goToSlide = function (e, i) {
            ...
            o.children.add(r.find(".bx-clone")).outerWidth(u()), o.viewport.css("height", v()+20), o.settings.ticker || S(), o.active.last && (o.active.index = x() - 1), o.active.index >= x() && (o.active.last = !0), o.settings.pager && !o.settings.pagerCustom && (w(), q(o.active.index))
